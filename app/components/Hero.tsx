...
const roles = ["Backend Developer", "Node.js Engineer", "MERN Stack Developer"];
...
export default function Hero() {
    ...
    return (
        <section className="min-vh-100 d-flex flex-column justify-content-center align-items-center text-center px-3">
            ...
            <h1 className="display-2 fw-bold text-light mb-2">Mohd Rashid Siddiqui</h1>
            <h2 className="h4 text-primary mb-3">
                {displayText}
                <span className="cursor text-primary">|</span>
            </h2>
            <p className="text-secondary fs-5 mb-0">3+ years building reliable backend and full-stack web applications.</p>
